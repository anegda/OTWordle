...
window.onload = () => {    
    ...
    // Select contestant by date
    const todayDate = new Date().toISOString().split('T')[0];
    
    // Find the object with today's date
    concursante = mydata.find(item => item.fecha === todayDate);
...
function shareOnTwitter() {
  ...
  var tweetText = '¡He acertado el #OTWordle en ' + intentos.toString() + " intentos! #OT2025 #OTDirecto"+formattedDate;
